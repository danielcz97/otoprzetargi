  ...
  <div class="container position-relative mt-n6 z-index-20 " style="margin-top: -56px">
      <ul class="nav nav-tabs search-bar-nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="#wierz" data-bs-toggle="tab" role="tab">Wierzytelności</a>
          </li>
      </ul>
              ...
              <div class="tab-pane fade show active" id="buy" role="tabpanel">
                  <form action="{{ route('search.nieruchomosci') }}" method="GET">
                      <div class="row">
                          ...
                          <button class="btn btn-primary mb-4 nier-button" type="button">Filtry zaawansowane</button>
